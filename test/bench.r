...
res2 <- GetBestPaths('/data/gcre/sim_lof_500', nCases = 500, nControls = 500, method = 'direct', threshold_percent = 1, K = 8, pathLength = 4, iterations = 10, strataF = NA, nthreads = 4)
