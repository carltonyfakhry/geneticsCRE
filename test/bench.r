...
res2 <- GetBestPaths('/data/gcre/testdata', nCases = 1537, nControls = 1537, method = 2, threshold_percent = 0.05, K = 4, pathLength = 4, iterations = 100, strataF = NA, nthreads = 4)

# res2 <- GetBestPaths('/data/gcre/huge/SimData_LoF_5000_LDLR-CDK19-APOE-LPL-LRP1_1.txt',
#   nCases = 5000, nControls = 5000, method = 'enrich', threshold_percent = 1, K = 4, pathLength = 3, iterations = 10, strataF = NA, nthreads = 4)
