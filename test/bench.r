...
res2 <- GetBestPaths('/data/gcre/testdata', nCases = 1537, nControls = 1537, method = 2, threshold_percent = 0.05, K = 12, pathLength = 5, iterations = 100, strataF = NA, nthreads = 1)
