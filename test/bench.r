...
res2 <- GetBestPaths('/data/gcre/testdata', nCases = 1537, nControls = 1537, method = 1, threshold_percent = 0.05, K = 4, pathLength = 4, iterations = 10, strataF = NA, nthreads = 4)
res2[,c("Paths", "Scores", "Pvalues")]

res2 <- GetBestPaths('/data/gcre/testdata', nCases = 1537, nControls = 1537, method = 2, threshold_percent = 0.05, K = 4, pathLength = 4, iterations = 10, strataF = NA, nthreads = 4)
res2[,c("Paths", "Scores", "Pvalues")]
