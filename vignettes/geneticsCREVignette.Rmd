...
`PGWAS` returns a list containing two data frames. The first data frame is `PGWAS.Results` which contains the top `K` paths for each length sorted in
